...
{
    class RealTime_TimeTrace_AveragedDataArrived_EventArgs_Sample_01 : EventArgs
    {
        ...
        public RealTime_TimeTrace_AveragedDataArrived_EventArgs_Sample_01(double AveragedData)
            : base()
        {
